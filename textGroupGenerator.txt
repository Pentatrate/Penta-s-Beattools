 ...
 */
function addText(time, order, id, text, horizontalAnchor, verticalAnchor, parentid, rotationInfluence, orbit, x, y, r, sx, sy, kx, ky, drawLayer, drawOrder, recolor, outline, effectCanvas, effectCanvasRaw) {
    text === undefined && (text = ""),
 ...
 * @param outline           optional
 * @param effectCanvas      optional
 * @param effectCanvasRaw   optional
 * @param duration          optional
 * @param ease              optional
 */
function easeText(time, order, id, parentid, rotationInfluence, orbit, x, y, r, sx, sy, kx, ky, drawLayer, drawOrder, recolor, outline, effectCanvas, effectCanvasRaw, duration, ease) {
    const textObj = texts[getIndexOfText(id)];
 ...
 * @param letterSubRandomize optional   how many randomizations any letter gets before the next letter starts or ends getting randomized (default: 1)
 */
...
/*
startTextGeneration(),
    addText(0, 0, "test", "", "middle", "middle", undefined, undefined, undefined, 300, 50, undefined, 2, 2, undefined, undefined, undefined, undefined, undefined, 2, undefined, undefined),
    funnyAnimation(0, "test", "testing 1 hello", 10, 4),
    easeText(2, undefined, "test", undefined, undefined, undefined, undefined, 360 - 50, 360, undefined, undefined, undefined, undefined, undefined, undefined, 1, undefined, undefined, undefined, 2, "outQuad"),
    funnyAnimation(2, "test", "testing 2 omagawd", 10, 4),
    changeAnchor(5, undefined, "test", "left", "top"),
    easeText(5, undefined, "test", undefined, undefined, undefined, undefined, undefined, 0, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, 2, "outQuad"),
    funnyAnimation(7, "test", "testing 3 e", 10, 4),
    easeText(10, undefined, "test", undefined, undefined, undefined, undefined, undefined, undefined, -2, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, 2, "outQuad"),
    endTextGeneration();
*/

startTextGeneration(),
    addText(0, 0, "tapInstruction", "bomb = tap", "middle", "top", undefined, undefined, undefined, 300, 360, undefined, 2, 2, undefined, undefined, "fg", 2, 4, undefined, undefined, undefined),
    easeText(0, 2, "tapInstruction", undefined, undefined, undefined, undefined, 360 - 24 - 20, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, 1, "outQuad"),
    easeText(5, 1, "tapInstruction", undefined, undefined, undefined, undefined, 360, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, 1, "outQuad"),
    easeText(6, 0, "tapInstruction", undefined, undefined, undefined, undefined, undefined, undefined, 0),
    endTextGeneration();
